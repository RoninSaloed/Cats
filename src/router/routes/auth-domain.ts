export class CommonDomainRoutes {
  ...
  static readonly FACT = "fact" as const;
  ...
  static readonly ABSOLUTE_FACT =
    `${CommonDomainRoutes.HOME}/${CommonDomainRoutes.FACT}` as const;
  ...
  static readonly N_FACT = "Fact" as const;
}
